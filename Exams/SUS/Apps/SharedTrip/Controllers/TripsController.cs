...
namespace SharedTrip.Controllers
{
    public class TripsController : Controller
    {
        ...
        public HttpResponse Add(AddTripInputModel input)
        {
            ...
            {
                return this.Error("End points is required.");
            }
            ...
            {
                return this.Error("Description is required and has max length 80.");
            }
            if (!DateTime.TryParseExact(input.DepartureTime, "dd.MM.yyyy HH:mm", CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.None, out _))
            {
                return this.Error("Ivalid departure time. Please use dd.MM.yyyy HH:mm format.");
            }
